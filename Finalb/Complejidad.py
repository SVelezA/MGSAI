...
titulo = Label(master, text= "Aplicativo de simulacion de costos", background = "white")
titulo.place(x=230, y= 15)

descripcion1 = Label(master, text = "A continuacion, seleccione las condiciones particulares de su proyecto.", background = "white")
