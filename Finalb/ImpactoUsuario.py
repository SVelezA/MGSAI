...
rdbtnEc = Radiobutton(app,text="Económico",width=7,value=7,command=Economico,background="white")
...
rdbtnPol = Radiobutton(app,text="Político",width=5,value=9,command=Politico,background="white")
